...
mysqldump -ufleshlig_magento -pr8R7Q7mBgeYS fleshlig_magento -t  \
    ...
    --ignore_table fleshlig_magento.customer_address_entity \
    --ignore_table fleshlig_magento.customer_address_entity_datetime \
    --ignore_table fleshlig_magento.customer_address_entity_decimal \
    --ignore_table fleshlig_magento.customer_address_entity_int \
    --ignore_table fleshlig_magento.customer_address_entity_text \
    --ignore_table fleshlig_magento.customer_address_entity_varchar \
    --ignore_table fleshlig_magento.customer_entity \
    --ignore_table fleshlig_magento.customer_entity_decimal \
    --ignore_table fleshlig_magento.customer_entity_int \
    --ignore_table fleshlig_magento.customer_entity_text \
    --ignore_table fleshlig_magento.customer_entity_varchar \
